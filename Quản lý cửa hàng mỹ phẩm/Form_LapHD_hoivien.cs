...
{
    public partial class Form_LapHD_hoivien : Form
    {
        string _tennv;
        decimal _tongtien = 0;
        decimal _tiengiam = 0;
        ...
        public Form_LapHD_hoivien()
        {
            InitializeComponent();
        }

        private void Form_LapHD_hoivien_Load(object sender, EventArgs e)
        {
            resettext();
        }
        ...
        private void btn_laphd_Click(object sender, EventArgs e)
        {
            ...
            int mahv = Convert.ToInt32(txt_mahv.Text);
            string manv = txt_manv.Text;
            DateTime ngaylap = Convert.ToDateTime(txt_ngaylap.Text);
            this.Tiengiam = hoivien.get_tiengiam(mahv);
            decimal tongtien = Convert.ToDecimal(txt_tongtien.Text) - this.Tiengiam;
            DTO_Hoa_Don laphd = new DTO_Hoa_Don(mahd, manv, mahv, ngaylap, tongtien);
            if (hoadon.insert_HoaDon_hoivien(laphd))
            {
